...
max_memory = 5000               # max memory for each solver process in MB
...
lemmaPush_timeoutMin = 10000    # a timespan to distribute solvers "push operation" to the lemma server
lemmaPush_timeoutMax = 15000
lemmaPull_timeoutMin = 20000    # a timespan to distribute solvers "pull operation" to the lemma server
lemmaPull_timeoutMax = 30000
